...
def setup_faq_page(self):
    ...
    faqs = [
        ...
        ("Can CannaCheck™ measure extracts?", "No, CannaCheck™ cannot measure extracts at this time. This is something we are working on for the future."),
        ...
        ("What other industries use CannaCheck™?", "CannaCheck™'s technology is used in industries such as big agriculture, pharmaceuticals, and food & beverage."),
        ...
        ("What can CannaCheck™ test for?", "CannaCheck™ can test for THC-A, CBD-A, THC, CBD, Total THC, and Total CBD. We hope to release new models soon which will test for Total Terpenes, moisture content, and water activity."),
        ...
        ("Will CannaCheck™ match my lab values?", "CannaCheck™ results are highly accurate and comparable to lab values, but slight variations may occur due to sample preparation, sample size, natural variance, and other factors."),
    ]
