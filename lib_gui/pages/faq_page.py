...
def setup_faq_page(self):
    ...
    faqs = [
        ...
        ("How accurate is CannaCheck™'s kiosk?",
        ...
        ("Why do samples from the same plant show different results?",
         "Variations can occur due to differences in sample preparation and environmental factors. Environmental factors are the most prevalent, primarily due to the natural variance in cannabis flower itself. Examples of variations in sample preparation include differing levels of fineness in the ground flower, holes where light can shine through the sample, or dirty sample cups or sample cups with fingerprints on the bottom."),
        ...
        ("How do I get the most consistent results?",
        ...
        ("Can CannaCheck™ measure extracts?",
         "No, CannaCheck™ cannot measure extracts at this time. This is something we are working on for the future."),
        ("Can CannaCheck™ measure edibles or infused products?",
        ...
        ("Can CannaCheck™ measure contaminants (pesticides, molds etc)?",
        ...
        ("What other industries use CannaCheck™?",
         "CannaCheck™'s technology is used in industries such as big agriculture, pharmaceuticals, and food & beverage."),
        ("Is CannaCheck™ a state-certified test method?",
        ...
        ("What are optimal use-cases for CannaCheck™?",
        ...
        ("Is CannaCheck™ supposed to eliminate outside lab-testing?",
         "No, CannaCheck™ is designed to complement outside lab-testing."),
        ("What can CannaCheck™ test for?",
         "CannaCheck™ can test for THC-A, CBD-A, THC, CBD, Total THC, and Total CBD. We hope to release new models soon which will test for Total Terpenes, moisture content, and water activity."),
        ("How is CannaCheck™ different than HPLC or GC?",
         "CannaCheck™ uses spectroscopy, which is faster and less expensive than HPLC or GC."),
        ("Will CannaCheck™ match my lab values?",
